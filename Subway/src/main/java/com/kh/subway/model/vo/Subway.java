...
public class Subway {
	...
	public Subway(String name, String phone, String address, String request, String sandwich, String vegetable,
			String sauce, String cookie, String payment, Date orederDate) {
		super();
		this.name = name;
		this.phone = phone;
	...
	@Override
	public int hashCode() {
		return Objects.hash(address, cookie, name, orederDate, payment, phone, request, sandwich, sauce, vegetable);
	}
	@Override
	public boolean equals(Object obj) {
		...
		return Objects.equals(address, other.address) && Objects.equals(cookie, other.cookie)
				&& Objects.equals(name, other.name) && Objects.equals(orederDate, other.orederDate)
	...
	public String toString() {
		return "Subway [name=" + name + ", phone=" + phone + ", address=" + address + ", request=" + request
				...
				+ ", payment=" + payment + ", orederDate=" + orederDate + "]";
	}
