...
<body>
	...
	<div style="width : 80%; margin : auto; padding : 50px;">
		<form action="update.me" name="myPage" id="signUpForm" method="post">
			<table
				...
				<tr>
					<td><input type="text" name="userId" id="user_id"
						...
						value="${userInfo.userId}" readonly><!-- 로그인 된 사용자 아이디 -->
						</td>
				...
				<tr>
					<td><input type="text" name="userName" id="user_name"
						...
						required="required" aria-required="true"
						style="margin-bottom: 25px; width: 100%; height: 40px; border: 1px solid #d9d9de"
						placeholder="한글로 최대 6자" value="${userInfo.userName}"></td><!-- 로그인된 사용자 이름 -->
				</tr>
				...
				<tr>
					<td><input type="email" name="email" id="user_email"
						...
						required="required" aria-required="true"
						style="margin-bottom: 25px; width: 100%; height: 40px; border: 1px solid #d9d9de"
						placeholder="ex) kh@kh.com" value="${userInfo.email}"></td><!-- 로그인된사용자이메일 -->
				</tr>
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <form action="delete.me" method="post">
	         <!-- input type="hidden" name="userNo" value="${userInfo.userNo}"해서 앞단에 포함해서 넘길 수 있는데 마음대로 수정해서 보낼 수 있으니 위험하니, 일반적으로 session에서 뽑아노는 것이 안정적이다. --> 
