		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav text-uppercase ml-auto">
					...
					<li class="nav-item"><a class="nav-link js-scroll-trigger"
						href="/kh/images?page=1">사진게시판</a></li>
					...
					<c:choose>
						...
						<c:otherwise>
							...
							<li class="nav-item">
								<!-- a 태그니깐 return false / mapping 값 : logout / a 태그는 get방식  -->
								<a class="nav-link js-scroll-trigger" href="logout"
								onclick="return confirm('진짜로 로그아웃 하려고?')">로그아웃</a>
							</li>
						</c:otherwise>
					</c:choose>
				...
				<div class="modal-body">
					...
					<form action="login" name="sign-in" method="post" id="signInForm"
						...
						<table
							...
							<tr>
								<!-- 정석은 암호화된 비밀번호의 검증 필요 -->
								<td>
									<!-- 정석은 dto-service(암호화)-바뀐 암호화된 비밀번호 vo에 가서 저장-dao --> <input
									type="text" name="userId" id="signInId"
